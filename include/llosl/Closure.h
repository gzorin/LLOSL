...
public:
    ...
    static std::unique_ptr<Closure> create(LLOSLContext&, llvm::StringRef, unsigned, llvm::ArrayRef<OSL::ClosureParam>, llvm::Module * = nullptr);
...
private:
    ...
    static std::unique_ptr<Closure> create(LLOSLContextImpl&, llvm::StringRef, unsigned, llvm::ArrayRef<OSL::ClosureParam>, llvm::Module * = nullptr);
